 ...
 */
final class Version20240425033045 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE early_booking_range_rule (id SERIAL NOT NULL, booking_date_from VARCHAR(5) NOT NULL, booking_date_to VARCHAR(5) NOT NULL, PRIMARY KEY(id))');
